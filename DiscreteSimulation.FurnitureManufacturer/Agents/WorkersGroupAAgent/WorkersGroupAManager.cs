...
{
	//meta! id="7"
	public class WorkersGroupAManager : OSPABA.Manager
	{
		public WorkersGroupAManager(int id, OSPABA.Simulation mySim, Agent myAgent) :
		...
		//meta! sender="WorkersAgent", id="45", type="Notice"
		...
		//meta! sender="WorkersAgent", id="41", type="Request"
		...
		//meta! sender="WorkersAgent", id="48", type="Request"
		...
		//meta! tag="end"
		public new WorkersGroupAAgent MyAgent
		{
			get
			{
				return (WorkersGroupAAgent)base.MyAgent;
			}
		}
	}
}