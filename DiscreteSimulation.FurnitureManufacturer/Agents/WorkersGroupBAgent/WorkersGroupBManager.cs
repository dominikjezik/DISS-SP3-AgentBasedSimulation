...
{
	//meta! id="8"
	public class WorkersGroupBManager : OSPABA.Manager
	{
		public WorkersGroupBManager(int id, OSPABA.Simulation mySim, Agent myAgent) :
		...
		//meta! sender="WorkersAgent", id="46", type="Notice"
		...
		//meta! sender="WorkersAgent", id="43", type="Request"
		...
		//meta! sender="WorkersAgent", id="76", type="Request"
		...
		//meta! tag="end"
		public new WorkersGroupBAgent MyAgent
		{
			get
			{
				return (WorkersGroupBAgent)base.MyAgent;
			}
		}
	}
}